    ...
    switch (name) {
        ...
        case 0x1F03: { // GL_EXTENSIONS
            ...
            static const char* kExt =
                ...
                "GL_ARB_multitexture "
                /* "GL_ARB_pixel_buffer_object " */ // <--- Disabled to prevent Globed PBO OOM crash on Vulkan
...
extern "C" __declspec(dllexport) void WINAPI gl_glCopyTexImage2D(GLenum target, GLint level, GLenum internalformat, GLint x, GLint y, GLsizei width, GLsizei height, GLint border) {
    static auto real = (void(WINAPI*)(GLenum, GLint, GLenum, GLint, GLint, GLsizei, GLsizei, GLint))GetProcAddress(GetModuleHandleA("libGLESv2.dll"), "glCopyTexImage2D");
...
extern "C" __declspec(dllexport) void WINAPI gl_glCopyTexSubImage2D(GLenum target, GLint level, GLint xoffset, GLint yoffset, GLint x, GLint y, GLsizei width, GLsizei height) {
    static auto real = (void(WINAPI*)(GLenum, GLint, GLint, GLint, GLint, GLint, GLsizei, GLsizei))GetProcAddress(GetModuleHandleA("libGLESv2.dll"), "glCopyTexSubImage2D");
    if (real) real(target, level, xoffset, yoffset, x, y, width, height);
}

extern "C" __declspec(dllexport) void WINAPI gl_glReadPixels(GLint x, GLint y, GLsizei width, GLsizei height, GLenum format, GLenum type, void* pixels) {
    static auto real = (void(WINAPI*)(GLint, GLint, GLsizei, GLsizei, GLenum, GLenum, void*))GetProcAddress(GetModuleHandleA("libGLESv2.dll"), "glReadPixels");
